...
export const tools: Tool[] = [
  {
    id: "s-corp-tax-estimator",
    name: "S-Corp Tax Estimator",
    category: Categories.CALCULATORS,
    icon: Calculator,
    color: "from-blue-600 to-blue-400",
    description: "Estimate S-Corp taxes with ease",
    Component: () => (
      <TaxBracketProvider>
        <SCorpTaxCalculator />
      </TaxBracketProvider>
  ...
  {
    id: "llc-tax-estimator",
    name: "LLC Tax Estimator",
    category: Categories.CALCULATORS,
    icon: Calculator,
    color: "from-green-600 to-green-400",
    description: "Estimate LLC taxes with ease",
    Component: () => (
      <TaxBracketProvider>
        <LLCTaxCalculator />
      </TaxBracketProvider>
